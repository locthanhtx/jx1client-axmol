...
LUA_API int lua_call (lua_State *L, int nargs, int nresults) {
  StkId func = L->top - (nargs+1);  /* function to be called ���㣿=1 */
  struct CallS c;
  int status;
...
/*
** {======================================================
** Error-recover functions (based on int32_t jumps)
** =======================================================
*/

/* chain list of int32_t jump buffers */
struct lua_longjmp {
  jmp_buf b;
