...
//����ȷ��������
KuiSuperShop * KuiSuperShop::create(BuySellInfo* pBSinfo,Ref * callbackListener,const std::function<void(ax::Node*)>& callfun)
{
	KuiSuperShop * popLayer = KuiSuperShop::create();
	//popLayer->setTitle(title);
	popLayer->UpdateShop(pBSinfo);
	popLayer->m_CurShopIdx = 0;
...
void KuiSuperShop::addDialoaData()
{
...
//����ȷ��ȡ����ť,���������ò���󣬵��ò�ص�����
void KuiSuperShop::setcoloseButton(Ref * callbackListener,const std::function<void(ax::Node*)>& callfun)
{
	...
	MenuItemSprite * buyConfirm   = MenuItemSprite::create(sprite_buy_normal, sprite_buy_select, CC_CALLBACK_1(KuiSuperShop::buyCallBackFunc, this));
	...
	MenuItemSprite * closeConfirm   = MenuItemSprite::create(sprite_close_normal, sprite_close_select, CC_CALLBACK_1(KuiSuperShop::closeCallBackFunc, this));
	...
	MenuItemSprite * backConfirm   = MenuItemSprite::create(sprite_back_normal, sprite_back_select, CC_CALLBACK_1(KuiSuperShop::backCallBackFunc, this));
	...
	MenuItemSprite * nextConfirm   = MenuItemSprite::create(sprite_next_normal, sprite_next_select, CC_CALLBACK_1(KuiSuperShop::nextCallBackFunc, this));
...
//��һҳ
void KuiSuperShop::backCallBackFunc(Ref * pSender)
{
	if (m_descPadIsOpen)
	{
		m_descPadIsOpen =false;
...
//��һҳ
void KuiSuperShop::nextCallBackFunc(Ref * pSender)
{
	if (m_descPadIsOpen)
	{
		m_descPadIsOpen =false;
...
//ִ���ϲ����Ļص��������رյ�����
void KuiSuperShop::buyCallBackFunc(Ref * pSender)
{
	if  (m_selItemIndex<0)
	{
#ifdef WIN32
...
void KuiSuperShop::closeCallBackFunc(Ref * pSender)
{
...
//�رյ�����
void KuiSuperShop::closePopLayer(Ref * pSender)
{
	this->removeFromParentAndCleanup(true);
}
...
//��д����ע�ắ�������¸�����������
void KuiSuperShop::registerWithTouchDispatcher()
{
...
Rect KuiSuperShop::getRect(Node* pNode,int i)
{
	Rect  rc;
...
//��������ccTouchBegan������true
bool KuiSuperShop::ccTouchBegan(Touch *pTouch, Event *pEvent)
{
		...
		if (m_ItemIndex[i]>=0)
		{
			 ...
			 if  (nItemSpr && ncolorlable)
			 {
				 ...
				 {//������
					...
					// Layer * sDescLayer = KuiItemdesc::create("",second,this,CC_CALLBACK_1(KuiSuperShop::closedescPadCallback));
					 Layer * sDescLayer = KuiItemdesc::create(m_CurShopIdx,second,this,CC_CALLBACK_1(KuiSuperShop::closedescPadCallback, this));
...
void KuiSuperShop::closedescPadCallback(Node *pNode)
{
	m_descPadIsOpen = false;
}
...
//������Ʒ
int KuiSuperShop::AddObject(KUiDraggedObject* pObject, int nCount)
{
