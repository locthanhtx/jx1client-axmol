...
int		KThiefSkill::DoSkill(KNpc * pNpc, int nX, int nY)
{
	...
	//if (m_szSkillSpecialFile[0])
		...
		Show.nNpcIndex = nY;
		//KMissle::CreateMissleForShow("\\spr\\skill\\NPC\\mag_npc_��ˮ��ʧ.spr", "30,1,1", "\\sound\\skill\\�������.wav", &Show);
...
//		g_DebugLog("�޷���%s", szSettingFile);
	...
	TabFile.GetString(2, "SkillIcon", "\\spr\\skill\\ͼ��\\ͨ��.spr", m_szSkillIcon, sizeof(m_szSkillIcon));
