...
//#include "Exception.h"
//#include "Utils.h"
CIOBuffer::CIOBuffer( Allocator &allocator, uint32_t size )
	:  m_operation( 0 )
      , m_sequenceNumber( 0 )
...
void CIOBuffer::operator delete( void *pObject, uint32_t/* bufferSize*/)
#else
...
CIOBuffer *CIOBuffer::SplitBuffer( uint32_t bytesToRemove )
{
...
VOID CIOBuffer::RemoveBuffer( uint32_t bytesToRemove )
{
...
void CIOBuffer::AddData( const char * const pData, uint32_t dataLength )
{
...
void CIOBuffer::AddData( const BYTE * const pData, uint32_t dataLength )
{
...
CIOBuffer::Allocator::Allocator( uint32_t bufferSize, uint32_t maxFreeBuffers )
