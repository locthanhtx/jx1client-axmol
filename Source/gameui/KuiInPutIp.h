...
//
//
#ifndef __KuiInPutIp__
#define __KuiInPutIp__
...
public:
	...
	virtual bool init();
	//����
	CREATE_FUNC(KuiInPutIp);

	static KuiInPutIp * create(Ref * callbackListener,const std::function<void(ax::Node*)>& callfun);
...
private:
	...
	//ִ���ϲ����Ļص��������رյ�����
	void buttonCallBackFunc(Ref * pSender,int ver);
