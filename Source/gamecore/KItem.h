...
//	KItemNormalAttrib	m_BaoShiMagicAttrib[6];	// ���ߵı�ʯ����
	...
	KItemNormalAttrib	m_TempPlatinaAttrib[6];	// ��ʱ�İ׽�ħ������ֵ�����ڸı����ԣ�
...
public:
	...
	void    SetWonName(char *strWonName){sprintf(m_CommonAttrib.szWonName, "%s", strWonName);};  //�����ù���
	...
	void    SetMagic(int nVal=0) { m_CommonAttrib.nISMagic=nVal;};       //() const { return m_CommonAttrib.nISMagic; };      //�Ƿ�ħ������
	...
	//void    SetSItmeInfo(char *SItemInfo) {ZeroMemory(m_CommonAttrib.ItmeInfo,sizeof(m_CommonAttrib.ItmeInfo));_snprintf(m_CommonAttrib.ItmeInfo,sizeof(m_CommonAttrib.ItmeInfo)-1,"%s",SItemInfo);};  //������˵��
...
//	int		GetBaoShiAttribType( int i = 0) const { return m_BaoShiMagicAttrib[i].nAttribType; }; //  ���͵õ��������Ե�
	...
	BOOL    SetAttrib_RON(IN const KItemNormalAttrib*);             //��������
	BOOL    SetAttrib_Bao(IN const KItemNormalAttrib*);             //��ʯ����
...
//�ͻ���
	...
	void    SetItmeInfo(char *ItemInfo) {memset(m_CommonAttrib.szIntro,0,sizeof(m_CommonAttrib.szIntro));sprintf(m_CommonAttrib.szIntro,"%s",ItemInfo);};  //������˵��
//	void    SetItmeInfo(char *ItemInfo) {m_CommonAttrib.szIntro = ItemInfo;};
	...
	void	Paint(int nX, int nY,BOOL bStack = TRUE,int nzStackNum=0,int nKind=-1);  //Ĭ�������
	//��ȡ����
