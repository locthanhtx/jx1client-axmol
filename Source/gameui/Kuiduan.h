...
public:
	...
	static Kuiduan * create(char * strTitel,char *pContent,int nNum,char* pszCallback,char* pszError,Ref * callbackListener,const std::function<void(ax::Node*)>& callfun);
